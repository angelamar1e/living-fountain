            ...
            <div class="row">
                ...
                <div class="row border rounded border-dark p-3 justify-content-center">
                        <div style="padding-right:5%;" class="col-4">
                            ...
                            <div class="row">
                                <div class="col-4"><input  class="w-100 text-center" type="text" id="blk" name="blk" required></div>
                                <div class="col-4"><input  class="w-100 text-center" type="text" id="lot" name="lot" required></div>
                                <div class="col-4"><input class="w-100 text-center" type="text" id="ph" name="ph" required></div>
                            </div>
                        </div>
                        <!-- order info -->
                        <div class="col-6 p-0">
                            ...
                            <div class="row">
                                <div class="col-3 text-center"><label for="type">Type</label></div>
                                <div class="col-6 text-center"><label for="qty"> Quantity</label></div>
                                <div class="col-1 text-center justify-content-left"><label for="deliverer"> Deliverer</label><br></div>
                            </div>
                        ...
                        <div class="col-2 d-flex justify-content-center align-items-center" style="margin-top: 3%; height: 80%; hover:background-color: #0056b3 !important">
                            <!-- submit button -->
